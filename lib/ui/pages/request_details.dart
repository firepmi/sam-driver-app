...
class _RequestDetailsPageState extends State<RequestDetailsPage> {
  ...
  void getClientInfo(String clientId) {
    if (clientData != null) return;
    dataBloc.getClientInfo(clientId, (client) {
      clientData = client;
      dataBloc.getProfileImage((profileUrl) {
        clientProfileUrl = profileUrl;
        setState(() {});
      }, uid: clientId);
      setState(() {});
    });
  ...
  void onAccept() {
    dataBloc.acceptOffer(data["data_id"], () {
  ...
  void onReject() {
    dataBloc.rejectOffer(data["data_id"], () {
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(
                  children: [
                    AppStyle.label(context, "Client Info:",
                        size: 7, bottom: 10),
                    Row(children: [
                      data["profile"] != null
                    ...
                    Row(
                      children: [
                        Expanded(
                            child: AppStyle.button(context, "Accept",
                                onPressed: onAccept)),
                        Expanded(
